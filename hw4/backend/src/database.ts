...
export function insertTestData() {
  ...
  if (existingCafes.count === 0) {
    ...
    const testCafes = [
      ['Cafe Nomad', '舒適的工作空間，提供優質咖啡和快速 WiFi', '台北市大安區復興南路一段 253 號', '辦公友善', 4.5, 2, 1, 1, 0, 0, 1, 1, 1, '2025-01-01T00:00:00Z', '2025-01-01T00:00:00Z'],
      ['Coffee Stand', '明亮開闊的空間，適合長時間工作', '台北市中正區羅斯福路三段 283 巷 21 號', '辦公友善', 4.3, 2, 1, 1, 0, 0, 1, 1, 1, '2025-01-02T00:00:00Z', '2025-01-02T00:00:00Z'],
      ['Fika Fika Cafe', '北歐風格咖啡廳，環境舒適安靜', '台北市中山區伊通街 33 號', '精品咖啡', 4.6, 3, 1, 0, 1, 0, 1, 0, 1, '2025-01-03T00:00:00Z', '2025-01-03T00:00:00Z'],
      ['Rufous Coffee', '專業手沖咖啡，環境優雅', '台北市中山區民生東路三段 142 號', '精品咖啡', 4.7, 3, 1, 1, 0, 0, 1, 1, 1, '2025-01-04T00:00:00Z', '2025-01-04T00:00:00Z'],
      ['Congrats Cafe', '時尚簡約風格，適合聚會和工作', '台北市信義區松仁路 90 號', '辦公友善', 4.4, 2, 1, 1, 0, 1, 1, 1, 1, '2025-01-05T00:00:00Z', '2025-01-05T00:00:00Z'],
      ['Louisa Coffee', '連鎖咖啡品牌，環境整潔服務穩定', '台北市松山區南京東路四段 133 號', '連鎖品牌', 4.1, 2, 1, 1, 0, 1, 1, 1, 1, '2025-01-06T00:00:00Z', '2025-01-06T00:00:00Z'],
      ['Cafe Lugo', '日式風格咖啡廳，提供手沖咖啡', '台北市萬華區西門町成都路 10 號', '日式風格', 4.4, 3, 0, 0, 1, 0, 0, 1, 1, '2025-01-07T00:00:00Z', '2025-01-07T00:00:00Z'],
      ['The Coffee Bean', '美式風格咖啡廳，空間寬敞舒適', '台北市士林區天母東路 69 號', '美式風格', 4.2, 2, 1, 1, 0, 1, 1, 1, 1, '2025-01-08T00:00:00Z', '2025-01-08T00:00:00Z'],
    ];
